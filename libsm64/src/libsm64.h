...
struct SM64MarioState
{
    ...
    float leftForeArmAngle[3];
    float rightForeArmAngle[3];
    float leftHandAngle[3];
    float rightHandAngle[3];
    float leftLegAngle[3];
    float rightLegAngle[3];
    float leftAnkleAngle[3];
    float rightAnkleAngle[3];
    float leftFootAngle[3];
    float rightFootAngle[3];
    float torsoAngle[3];
    int16_t health;
    uint32_t action;
...
extern SM64_LIB_FN void sm64_set_mario_leftleg_angle(int32_t marioId, float x, float y, float z);
extern SM64_LIB_FN void sm64_set_mario_rightleg_angle(int32_t marioId, float x, float y, float z);
extern SM64_LIB_FN void sm64_set_mario_leftankle_angle(int32_t marioId, float x, float y, float z);
extern SM64_LIB_FN void sm64_set_mario_rightankle_angle(int32_t marioId, float x, float y, float z);
extern SM64_LIB_FN void sm64_set_mario_leftfoot_angle(int32_t marioId, float x, float y, float z);
extern SM64_LIB_FN void sm64_set_mario_rightfoot_angle(int32_t marioId, float x, float y, float z);
